...
import colecciones.pila.PilaSobreListasEnlazadas;

public class MainParentesisBalanceadosSobreListasEnlazadas {
    ...
    public static void main(String[] args) throws ExcepcionPila {
        PilaSobreListasEnlazadas pila = new PilaSobreListasEnlazadas();
        String secuencia = "[()][()()]()";
