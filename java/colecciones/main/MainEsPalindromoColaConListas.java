// Los resultados son iguales con ambas implementaciones

package colecciones.main;

import java.util.Scanner;

import colecciones.cola.ColaConListas;

public class MainEsPalindromoColaConListas {
    /*
    ...
    public static void main(String[] args) {
        ColaConListas<String> cola = new ColaConListas<String>();
        ColaConListas<String> colaInversa = new ColaConListas<String>();
