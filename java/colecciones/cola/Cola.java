...
/**
 * Esta clase representa una cola de objetos <b>first in first out (FIFO)</b>
 * donde el primer elemento insertado es el primero que se accede.
 * Las operaciones disponibles para esta estructura son:
 * <ul>
 * <li>encolar : Encola un nuevo elemento y evaluar si fue encolado con
 * exito</li>
 ...
 * <li>repOK : Permite validar si una instancia satisface el invariante de
 * representación</li>
...
public interface Cola<T> {
	...
	/**
	 * Desencola el primer elemento de la cola, y retorna el elemento desencolado,
	 * si ésta no es vacía.
	 * 
